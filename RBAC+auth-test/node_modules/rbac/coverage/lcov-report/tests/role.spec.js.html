...
<html lang="en">
<head>
    <title>Code coverage report for tests/role.spec.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">tests/</a> role.spec.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  describe('RBAC ' + storageType, function () {
    var rbac = null;
    var response = null;
&nbsp;
    var permissions = [['create', 'article'], ['delete', 'user'], ['update', 'article']];
&nbsp;
...
&nbsp;
    it('decode permission', function () {
      var decoded = _index.Permission.decodeName('create_article');
&nbsp;
      (0, _should2.default)(decoded).not.equal(undefined);
&nbsp;
...
&nbsp;
    it('should be able to create roles and permissions', function (done) {
      rbac = new _index2.default({ storage: storage });
&nbsp;
...
&nbsp;
        response = data;
&nbsp;
        (0, _should2.default)(response).not.equal(undefined);
        response.should.have.properties(['roles', 'permissions']);
&nbsp;
        for (var i = 0; i &lt; roles.length; i++) {
          var name = roles[i];
          (0, _should2.default)(response.roles[name]).not.equal(undefined);
&nbsp;
          var instance = response.roles[name];
          (0, _should2.default)(instance.name).equal(name);
        }
&nbsp;
        for (var i = 0; i &lt; permissions.length; i++) {
          var permission = permissions[i];
          var name = _index.Permission.createName(permission[0], permission[1]);
          (0, _should2.default)(response.permissions[name]).not.equal(undefined);
&nbsp;
          // check name
...
&nbsp;
    it('should not be able to get permission through getRole', function (done) {
      rbac.getRole('create_article', function (err, permission) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >throw err;</span>
        (0, _should2.default)(permission).equal(null);
        done();
      });
    });
&nbsp;
...
&nbsp;
    it('should not be able to get role through getPermission', function (done) {
      rbac.getPermission('admin', '', function (err, admin) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >throw err;</span>
        (0, _should2.default)(admin).equal(null);
        done();
      });
    });
&nbsp;
...
&nbsp;
    it('should not be able to get removed role', function (done) {
      rbac.get('guest', function (err, role) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >throw err;</span>
        (0, _should2.default)(role).equal(null);
        done();
      });
    });
&nbsp;
...
&nbsp;
    it('should be able to create roles and permissions with constructor', function (done) {
      var localrbac = new _index2.default({
        roles: roles,
...
&nbsp;
    it('should be able to get scope for admin', function (done) {
      rbac.getScope('admin', function (err, scope) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >throw err;</span>
...
&nbsp;
    it('should be able to get scope for user', function (done) {
      rbac.getScope('user', function (err, scope) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >throw err;</span>
...
&nbsp;
    it('should be able to get scope for more complex object', function (done) {
      var rbac = new _index2.default({
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >throw err;</span>
&nbsp;
        instance.getScope('admin', function (err, scope) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >throw err;</span>
...
&nbsp;
var mongooseStorage = new _index.Mongoose({
  connection: _mongoose2.default.connect('mongodb://localhost/rbac')
});
testRBAC(mongooseStorage, 'Mongoose');</pre></td></tr>
</table></pre>
<div class='push'></div><!-- for sticky footer -->
</div><!-- /wrapper -->
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Feb 26 2016 18:04:34 GMT+0100 (CET)
</div>
</div>
